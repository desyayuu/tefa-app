...
return new class extends Migration
{
    ...
    {
        Schema::create('t_project_member_dosen', function (Blueprint $table) {
            $table->string('t_project_member_dosen_id', 36)->primary();
    ...
    {
        Schema::dropIfExists('t_project_member_dosen');
    }
};
