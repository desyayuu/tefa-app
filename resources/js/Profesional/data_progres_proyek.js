...
document.addEventListener('DOMContentLoaded', function () {
    ...
    $('#modalTambahProgresFromProfesional').on('shown.bs.modal', function () {
    ...
    $('#modalTambahProgresFromProfesional').on('hidden.bs.modal', function () {
    ...
    function initializeSelect2() {
        if (typeof $.fn.select2 !== 'undefined') {
            try {
                $('.select2-assign-leader').select2({
                    theme: 'bootstrap-5',
                    dropdownParent: $('#modalTambahProgresFromProfesional'),
                    placeholder: 'Pilih Project Leader',
                    width: '100%'
                });
