$(document).ready(function() {
    ...
    $("#btnSimpanDokumen").on("click", function() {
        ...
        const saveNextDocument = (index) => {
            ...
            $.ajax({
                url: `/dosen/proyek/dokumen-penunjang`, 
                type: 'POST',
                data: formData,
                processData: false,
                contentType: false,
    ...
    function loadDokumenPenunjang(page = 1) {
        ...
        $.ajax({
            url: `/dosen/proyek/${proyekId}/dokumen-penunjang`,
            type: 'GET',
            data: {
                search: searchParam,
                page: page,
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex gap-2">
                            <a href="/dosen/proyek/dokumen-penunjang/download/${dokumenId}" 
    ...
    function deleteDokumen(id) {
        $.ajax({
            url: `/dosen/proyek/dokumen-penunjang/${id}`,
            type: 'DELETE',
            headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            },
