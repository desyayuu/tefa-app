<div class="sidebar">
    ...
    <ul>
        ...
        <li>
            <a href="{{ route('mahasiswa.dataProyek') }}" class="{{ request()->routeIs('mahasiswa.dataProyek') || request()->routeIs('mahasiswa.detailProyek') ? 'active' : '' }}">
                <span class="icon">
        ...
        <li>
            <a href="{{ route('mahasiswa.portofolio') }}" class="{{ request()->routeIs('mahasiswa.portofolio') ? 'active' : '' }}">
                <span class="icon">
                <svg width="15" height="15" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <li>
            <a href="{{ route('mahasiswa.getProfilMahasiswa') }}" class="{{ request()->routeIs('mahasiswa.getProfilMahasiswa') ? 'active' : '' }}">
                <span class="icon">
                    <svg width="15" height="15" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
