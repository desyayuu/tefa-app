            ...
            <div class="title-table d-flex justify-content-between align-items-center mb-3">
                ...
                <div class="d-flex gap-2 align-items-center">
                    <div class="position-relative">
                        <form action="{{ route('dosen.getDataProyek') }}" method="GET">
                    ...
                    <a href="{{ route('dosen.getDataProyek') }}" class="btn btn-tutup btn-outline-secondary">
                        Hapus Filter
                    </a>
                    @endif
                </div>
            ...
            <table class="table">
                ...
                @forelse($data as $index => $item)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('dosen.detailProyek', $item->proyek_id) }}">
