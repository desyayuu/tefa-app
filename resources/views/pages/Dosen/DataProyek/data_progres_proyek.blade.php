<!-- Untuk section data progres proyek, semua data progres proyek akan ditampilkan di sini. -->
        ...
        <div class="card-body">
            <div id="progres-proyek-section" class="title-table d-flex justify-content-between align-items-center mb-3">
                ...
                <div class="d-flex gap-2 align-items-center">
                    ...
                    @if($isLeader)
                    <button type="button" class="btn btn-add" data-bs-toggle="modal" data-bs-target="#modalTambahProgresFromDosen">
                        Tambah Data
                    </button>
                    @endif
                </div>
...
<div class="modal fade" id="modalTambahProgresFromDosen" aria-hidden="true" aria-labelledby="modalTambahProgresLabel" tabindex="-1">
        ...
        <div class="modal-content">
            <form id="formEditProgres" novalidate>
                ...
                <div class="modal-body label-form">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <select class="form-select" id="edit_status_progres" name="status_progres" 
                                 required>
                                <option value="" selected disabled>Pilih Status</option>
                                <option value="Inisiasi" >Inisiasi</option>
                                <option value="In Progress">In Progress</option>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-add" id="btnUpdateProgres" {{$isLeader? '' : 'disabled'}}>Simpan Perubahan</button>
                </div>
            </form>
        </div>
    </div>
