<div class="detail-proyek-container flex-grow-1 me-3 pb-3">
    <div class="card shadow-sm border-0 rounded-3 h-100">
        <div class="card-body">
            ...
            <form id="formProyek" style="font-size: 14px;" action="{{ route('dosen.updateDataProyek', $proyek->proyek_id) }}" method="POST">
                @csrf
                @method('PUT')
                    ...
                    <div class="mb-3 row align-items-center">
                        ...
                        <div class="col-md-10">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control form-selection" id="dana_pendanaan" name="dana_pendanaan" value="{{ number_format($proyek->dana_pendanaan, 0, ',', '.') }}" disabled>
                            </div>
                        </div>    
                    </div>
