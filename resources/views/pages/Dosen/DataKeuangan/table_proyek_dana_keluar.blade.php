            ...
            <div class="title-table d-flex justify-content-between align-items-center mb-3">
                ...
                <div class="d-flex gap-2 align-items-center">
                    <div class="position-relative">
                        <form action="{{ route('dosen.dataKeluarKeuanganProyek') }}" method="GET" id="searchForm">
                    ...
                    <a href="{{ route('dosen.dataKeluarKeuanganProyek') }}" class="btn btn-tutup btn-outline-secondary" id="clearSearchBtn">
                        Hapus Filter
                    </a>
                    @endif
                </div>
