        ...
        <div class="card-body">
            <div id="my-progres-proyek-section" class="title-table d-flex justify-content-between align-items-center mb-3">
                ...
                <div class="d-flex gap-2 align-items-center">
                    ...
                    <button type="button" class="btn btn-add" data-bs-toggle="modal" data-bs-target="#modalTambahProgresFromProfesionalSelf">
                        Tambah Data
                    </button>
                </div>
            </div>
            ...
            <div class="alert alert-info alert-sm mb-3" id="myProgresInfo">
                <small>
                    Progres Saya menampilkan progres yang Anda buat atau yang ditugaskan kepada Anda di proyek ini <strong>{{ $proyek->nama_proyek ?? 'Proyek' }}</strong>.
                </small>
            </div>
...
<div class="modal fade" id="modalTambahProgresFromProfesionalSelf" aria-hidden="true" aria-labelledby="modalTambahMyProgresLabel" tabindex="-1">
                ...
                <div class="modal-body label-form">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" id="my_assignment_display" readonly value="{{ $profesionalInfo->nama_profesional ?? 'Nama tidak ditemukan' }}">
                            </div>
