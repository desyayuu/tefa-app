    ...
    <div class="card shadow-sm border-0 rounded-3">
        <div class="card-body">
            <div class="title-filter d-flex justify-content-between align-items-center mb-3">
                <h5 class="m-0">Partisipasi Dosen dalam Proyek</h5>
                <div class="d-flex gap-2 align-items-center">
                    <div class="position-relative">
                        <form action="" method="GET">
                            ...
                            <input type="text" name="search_partisipasi" class="form-control pe-5 form-search" 
                                   placeholder="Cari partisipasi dosen..." value="{{ $searchPartisipasi ?? '' }}">
                    ...
                    @if(isset($searchPartisipasi) && $searchPartisipasi)
                        <a href="{{ route('koordinator.dataDosen') }}{{ isset($search) && $search ? '?search=' . $search : '' }}" 
            ...
            <div class="alert alert-info">
                Menampilkan {{ $partisipasiDosen->count() }} hasil partisipasi untuk pencarian "{{ $searchPartisipasi }}"
            </div>
            @endif
