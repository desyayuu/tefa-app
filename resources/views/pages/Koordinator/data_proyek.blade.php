                    ...
                    <div class="modal fade" id="exampleModalToggle" aria-hidden="true" aria-labelledby="exampleModalToggleLabel" tabindex="-1">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <form action="{{ route('proyek.tambahDataProyek') }}" method="POST">
                                    @csrf
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <!-- Project Leader -->
                                        <div class="mb-3">
                                            <label for="project_leader" class="form-label label-form">Project Leader</label>
                                            <select class="form-select" id="project_leader_id" name="project_leader_id" required>
                                                <option value="" disabled selected>Pilih Projecet Leader</option>
                                                @foreach($dataDosen as $project_leader)
                                                    <option value="{{ $project_leader->dosen_id }}">{{ $project_leader->nama_dosen }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex gap-2">
                                <a href="{{ route('proyek.detailDataProyek', ['id' => $proyek->proyek_id]) }}">
