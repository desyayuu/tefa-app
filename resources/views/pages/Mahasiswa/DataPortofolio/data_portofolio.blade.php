<div class="content-table mt-4" id="section-portofolio">
    <div class="card border-0">
        <div class="card-body">
            <div id="alertContainerPortofolio"></div>
            ...
            <div class="title-table d-flex justify-content-between align-items-center mb-3" style="font-size: 14px;">
                ...
                <div class="d-flex gap-2 align-items-center">
                    <div class="position-relative">
                        <form action="{{ route('mahasiswa.portofolio') }}" method="GET" id="searchPortofolioForm">
                    ...
                    <a href="{{ route('mahasiswa.portofolio') }}?scroll_to=portofolio" class="btn btn-tutup btn-outline-secondary">
                        Hapus Filter
                    </a>
                    @endif
            ...
            <div class="alert alert-info">
                ...
                Menampilkan {{ $portofolioMahasiswa->count() }} hasil untuk pencarian "<strong>{{ $searchPortofolio }}</strong>"
            </div>
            @endif
            ...
            <div class="table-responsive">
                ...
                @if($portofolioMahasiswa->hasPages() || $portofolioMahasiswa->count() > 0)
                <div class="d-flex justify-content-between align-items-center mt-3">
                    <div class="showing-text text-muted">
                        Showing {{ $portofolioMahasiswa->firstItem() ?? 0 }} to {{ $portofolioMahasiswa->lastItem() ?? 0 }} 
                        of {{ $portofolioMahasiswa->total() ?? 0 }} entries
                    </div>
...
<div class="modal fade" id="modalTambahPortofolio" tabindex="-1" aria-labelledby="modalTambahPortofolioLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form id="formTambahPortofolio" method="POST" action="{{ route('mahasiswa.portofolio.tambah') }}">
                @csrf
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <div class="form-text">Contoh: Workshop Web Development, Lomba Programming, dll.</div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="penyelenggara" name="penyelenggara" placeholder="Nama instansi/organisasi">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="tingkat_kegiatan" class="form-label fw-bold">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="peran_dalam_kegiatan" class="form-label fw-bold">Peran dalam Kegiatan</label>
                                <input type="text" class="form-control" id="peran_dalam_kegiatan" name="peran_dalam_kegiatan" placeholder="Peserta, Pemateri, Juara 1, dll.">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="link_kegiatan" class="form-label fw-bold">Link Kegiatan</label>
                                <input type="url" class="form-control" id="link_kegiatan" name="link_kegiatan" placeholder="https://linkkegiatan.com">
                                <div class="form-text">Link dokumentasi, sertifikat, atau info kegiatan</div>
                            </div>
                        </div>
                    </div>
                    <div class="mb-3">
            ...
            <form id="formEditPortofolio" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="edit_nama_kegiatan" class="form-label fw-bold">
                                    Nama Kegiatan <span class="text-danger">*</span>
                                </label>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="edit_jenis_kegiatan" class="form-label fw-bold">
                                    Jenis Kegiatan <span class="text-danger">*</span>
                                </label>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="edit_penyelenggara" class="form-label fw-bold">Penyelenggara</label>
                                <input type="text" class="form-control" id="edit_penyelenggara" name="penyelenggara">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="edit_tingkat_kegiatan" class="form-label fw-bold">
                                    Tingkat Kegiatan <span class="text-danger">*</span>
                                </label>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="edit_peran_dalam_kegiatan" class="form-label fw-bold">Peran dalam Kegiatan</label>
                                <input type="text" class="form-control" id="edit_peran_dalam_kegiatan" name="peran_dalam_kegiatan">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="edit_link_kegiatan" class="form-label fw-bold">Link Kegiatan</label>
                                <input type="url" class="form-control" id="edit_link_kegiatan" name="link_kegiatan" placeholder="https://linkkegiatan.com">
                            </div>
                        </div>
                    </div>
                    <div class="mb-3">
                        <label for="edit_deskripsi_kegiatan" class="form-label fw-bold">Deskripsi Kegiatan</label>
                        <textarea class="form-control" id="edit_deskripsi_kegiatan" name="deskripsi_kegiatan" rows="3"></textarea>
                    </div>
                </div>
                <div class="modal-footer">
