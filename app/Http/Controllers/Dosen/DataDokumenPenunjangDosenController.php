...
class DataDokumenPenunjangDosenController extends Controller
{
    // Cek Role Dosen dalam Proyek
                ...
                if ($file->isValid()) {
                    ...
                    if ($file->move($uploadPath, $filename)) {
                        ...
                        DB::table('m_dokumen_penunjang_proyek')->insert([
                            ...
                            'created_at' => now(),
                            'created_by' => $dosenId, // Menggunakan dosen_id
                        ]);
    ...
    public function deleteDokumenPenunjang($id)
    {
        try {
            ...
            // Check role dosen dalam proyek
            $roleCheck = $this->checkDosenRole($dokumen->proyek_id, $dosenId);
